        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, session_service_1.createSession)(user._id, req.get("userAgent") || "")];
                case 2:
                    session = _a.sent();
                    accessToken = (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), { expiresIn: config_1.default.get("accessTokenLifeSpan") });
                    refreshToken = (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), { expiresIn: config_1.default.get("accessTokenLifeSpan") });
                    //return botht tokens
